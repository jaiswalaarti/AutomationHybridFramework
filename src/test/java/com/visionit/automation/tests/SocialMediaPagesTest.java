...
public class SocialMediaPagesTest extends BaseTest {
	...
	@Test
	public void tc_16_Newslette_subscriptio() {
		logger.info("Test case 16 started: tc_16_Newslette_subscriptio" );
		String confirationMessage = socialMediaPages.subscriptionOfNewsLetter();
		logger.info("confirmation message displayed is: "+confirationMessage);
		logger.info("Test case 16 endted: tc_16_Newslette_subscriptio" );
